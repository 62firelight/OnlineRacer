...
2. Install npm dependencies by running `npm install` in the project root directory:
3. Once all npm dependencies are installed, you can start the project by running `deno run start-server` or `npm run dev`.
